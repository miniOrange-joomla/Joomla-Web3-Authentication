...
if (!defined("S_MATH_BIGINTEGER_MODE")) {
    if (extension_loaded("gmp")) {
        ...
        if (!defined("S_MATH_BIGINTEGER_QUIET")) {
            wp_die("Our Web3 Authentication plugin requires <a href='https://www.php.net/manual/en/book.gmp.php' target='_blank'> gmp </a> or <a href='https://www.php.net/manual/en/book.bc.php' target='_blank'> bcmath </a> PHP extension to be installed on your WordPress server.") ;
        }
    }
}
